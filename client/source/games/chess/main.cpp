...
void chessBoard(QWidget *baseWidget, Tile *tile[8][8])
{
    ...
    //borderDisplay
    {
    border[0]->outline(baseWidget,0,105,0);
    border[1]->outline(baseWidget,0,637,0);
    border[2]->outline(baseWidget,0,125,1);
    border[2]->outline(baseWidget,532,125,1);
    }
...
int main(int argc, char *argv[])
{
    ...
    myWidget->setGeometry(0,0,1400,700);
